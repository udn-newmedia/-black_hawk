<template>
  <div class="black-hawk">
    <div
      ...
      :style="{
        backgroundImage: isMob ? 'url(https://udn.com/newmedia/cms_assets/black_hawk/imgs/mob_1_new.jpg)' : 'url(https://udn.com/newmedia/cms_assets/black_hawk/imgs/Web_1_new.jpg)'
      }"
    />
    <div
      :class="{
      ...
      :style="{
        backgroundImage: isMob ? 'url(https://udn.com/newmedia/cms_assets/black_hawk/imgs/mob_2_new.jpg)' : 'url(https://udn.com/newmedia/cms_assets/black_hawk/imgs/Web_2_new.jpg)'
      }"
    />
    <div
      :class="{
      ...
      :style="{
        backgroundImage: isMob ? 'url(https://udn.com/newmedia/cms_assets/black_hawk/imgs/mob_3_new.jpg)' : 'url(https://udn.com/newmedia/cms_assets/black_hawk/imgs/Web_3_new.jpg)'
      }"
    />
    <div
      :class="{
      ...
      :style="{
        backgroundImage: isMob ? 'url(https://udn.com/newmedia/cms_assets/black_hawk/imgs/mob_4_new.jpg)' : 'url(https://udn.com/newmedia/cms_assets/black_hawk/imgs/Web_4_new.jpg)'
      }"
    />
    <div ref="content1" class="black-hawk__content black-hawk__content--first-child">
      <img
        ref="content1_img"
        class="content1_img" 
        :src="isMob ? 'https://udn.com/newmedia/cms_assets/black_hawk/imgs/mob_1_new.jpg' : 'https://udn.com/newmedia/cms_assets/black_hawk/imgs/Web_1_new.jpg'" alt=""
      >
    ...
    <div ref="content2" class="black-hawk__content">
      <div class="black-hawk__content__text-wrapper">
        <p class="time">08:07</p>
        <p>飛行員失事前最後一次通聯。當時回報能見度7哩，雲高3000呎至5000呎，符合進場標準。</p>
        <p>失事黑鷹光點在距中正港328.7度17浬處消失。</p>
      </div>
    </div>
